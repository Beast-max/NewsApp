...
import com.example.newsapp.Adapter.FavroiteAdapter
...
class FavroiteFragment : Fragment() {
    ...
    private lateinit var favvm:FavroiteViewModel
    ...
    override fun onCreateView(
        ...
        Rv = view.findViewById(R.id.favrv)
        favvm = ViewModelProvider(this).get(FavroiteViewModel::class.java)
        Rv.layoutManager = LinearLayoutManager(context)


        favvm.getallrepo.observe(viewLifecycleOwner, Observer { Model->
            Rv.adapter = FavroiteAdapter(Model)
        })
